...
class Fahrt():
    ...
    def loop(self):
        ...
        if int(getTime.split(":")[0]) == 0 and int(getTime.split(":")[1]) < 30:
            color = Fore.LIGHTYELLOW_EX
        elif int(getTime.split(":")[0]) == 0 and int(getTime.split(":")[1]) < 10:
            color = Fore.LIGHTRED_EX
        else:
            color = Fore.LIGHTWHITE_EX

 
        print(color + "[>] Countdown: " + self.toTime(self.difference_secs) + R + "\r", end="")
